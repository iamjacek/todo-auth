...
const Signup = (props) => {
  ...
  const postRegister = (event) => {
    ...
    axios
      .post("https://todo001-001.herokuapp.com/auth/local/register", {
        username: userName,
        email: userEmail,
        password: password,
      })
      ...
      <CenterContainer maxWidth="xs">
        ...
        {isError && (
          <AlertMessage severity="error">
            Either user name or password are wrong or you did not set your
            passwords correctly.
          </AlertMessage>
        )}
        {isConnectionError && (
          <AlertMessage severity="error">
            Connection error. Contact us or try again later.
          </AlertMessage>
        )}
      </CenterContainer>
    </Box>
